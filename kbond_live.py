...
# ★[2026-09-15] 바램 단계를 «체결이 그 최우선 레벨에서 나나» 로 다시 맞췄다.
#   국고 전 이력 35,654건 — 최우선 호가의 나이별로 그때 난 체결이 그 레벨에서 난 비율:
#     ~1분 90.6% (n=27,973) · 1~5분 61.2% (4,709) · 5~15분 29.6% (2,018) · 15~30분 16.7% (953)
#   **벼랑은 1분이다.** 옛 값 (300, 900) 은 「신선」 한 칸에 90.6%와 61.2%를 같이 담고 있었다
#   (근거였던 v8 수치는 «레벨이 바뀔 확률» 이라 축이 다르다 — 안 바뀌어도 뚫린다).
#   RESULT_mark_and_age_2026-09-15.md · 값 `data\kbond\kbond_age_bands.json`
AGE_STEPS = (60, 300)       # 화면 바램 단계(초): 신선 <1분 · 익음 1~5분 · 노후 5분+
